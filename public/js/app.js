...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchData: function fetchData() {
      ...
      this.loading = true;
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/new/users').then(function (response) {
        _this.loading = false;
        _this.users = response.data.data; // console.log(response);
      }).catch(function (error) {
        _this.loading = false;
        _this.error = error.response.data.message || error.message;
      });
    },
    updateUserRole: function updateUserRole(id, role) {
      var _this2 = this;
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/new/update", {
        id: id,
        role: role,
    ...
    updateUserBlocked: function updateUserBlocked(id, blocked) {
      var _this3 = this;
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("/new/blocked", {
        id: id,
        blocked: blocked,
        _token: AppSettings.csrfToken
      }).then(function (response) {
      ...
      _c(
        ...
        _vm._l(_vm.users, function(user) {
          return _c("tr", [
            ...
            _vm._v(" "),
            _c("td", [_vm._v(" " + _vm._s(user.role[0].description))]),
            _vm._v(" "),
            user.user_role[0].blocked
              ? _c("td", [_vm._v(" Blocked")])
              : _c("td"),
            _vm._v(" "),
            _c("td", [
              _c(
                "button",
                {
                  on: {
                    click: function($event) {
                      _vm.updateUserRole(user.id, user.user_role[0].role_id)
                    }
                  }
                },
                [_vm._v("Change role")]
              ...
              _c(
                "button",
                {
                  on: {
                    click: function($event) {
                      _vm.updateUserBlocked(user.id, user.user_role[0].blocked)
                    }
                  }
                },
                [_vm._v("Block/unblok")]
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/DashboardComponent.vue?vue&type=template&id=01ab55f4&scoped=true&":
/*!*********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/DashboardComponent.vue?vue&type=template&id=01ab55f4&scoped=true& ***!
  \*********************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("H1", [_vm._v("Кабінет користувача")]),
      _vm._v(" "),
      _c("p", [
        _vm._v(
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("H1", [_vm._v("Початкова сторінка")]),
      _vm._v(" "),
      _c("p", [
        _vm._v(
          "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo. Nullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Sed fringilla mauris sit amet nibh. Donec sodales sagittis magna. Sed consequat, leo eget bibendum sodales, augue velit cursus nunc,"
...
/* harmony import */ var _components_RegisterComponent_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/RegisterComponent.vue */ "./resources/js/components/RegisterComponent.vue");
...
/* harmony import */ var _components_AdminComponent_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/AdminComponent.vue */ "./resources/js/components/AdminComponent.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  routes: [{
    ...
    path: '/register',
    name: 'register',
    component: _components_RegisterComponent_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    meta: {
      auth: false
    }
  }, {
    path: '/login',
    name: 'login',
    component: _components_LoginComponent_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    meta: {
      auth: false
    }
  }, {
    path: '/admin',
    name: 'admin',
    component: _components_AdminComponent_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    meta: {
      auth: true
    }
  }, {
...
__webpack_require__(/*! D:\Serge\os\OSPanel\domains\vuejsAdminka\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\Serge\os\OSPanel\domains\vuejsAdminka\resources\sass\app.scss */"./resources/sass/app.scss");
